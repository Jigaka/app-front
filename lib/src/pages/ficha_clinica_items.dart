...
class ItemsFichaFilters extends StatefulWidget {
  ...
  @override
  State<ItemsFichaFilters> createState() =>
      _ItemsFichaFiltersState(pacientes, fisios);
}

class _ItemsFichaFiltersState extends State<ItemsFichaFilters> {
  DateTime? selectedDateInicial;
  DateTime? selectedDateFinal;
  Paciente? idFisio;
  Paciente? idCliente;

  _ItemsFichaFiltersState(List<Paciente> pacientes, List<Paciente> fisios)
